...
gitCommand exogtn-3.1.x        clone    git@github.com:exoplatform/exogtn.git
#svnCommand xcmis-1.1.x         checkout --force $SVN_GOOGLE_CREDENTIALS https://xcmis.googlecode.com/svn/branches/1.1.x/
gitCommand gwtframework-1.0.x  clone    git@github.com:exoplatform/gwtframework.git
...
gitCommand platform-3.0.x      clone    git@github.com:exoplatform/platform.git
