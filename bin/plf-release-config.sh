...
# -----------------------OTHERS SUPPORTED ADDONS-------------------------------

# ----------------------------ACME PROPERTIES-----------------------------
RELEASE_ACME_BRANCH=release/4.3.x
CURRENT_SNAPSHOT_ACME_VERSION=4.3.x-SNAPSHOT
RELEASE_ACME_VERSION=4.3.0-RC1-1
NEXT_SNAPSHOT_ACME_VERSION=4.3.x-SNAPSHOT
RELEASE_ACME_JIRA_ID="$RELEASE_PLF_JIRA_ID"
ACME_PATCHES=
ACME_PATCHES_AFTER_RELEASE=


# ----------------------------ANSWERS PROPERTIES-----------------------------
RELEASE_ANSWERS_BRANCH=release/1.1.x
CURRENT_SNAPSHOT_ANSWERS_VERSION=1.1.x-SNAPSHOT
RELEASE_ANSWERS_VERSION=1.1.0-RC1-1
NEXT_SNAPSHOT_ANSWERS_VERSION=1.1.x-SNAPSHOT
RELEASE_ANSWERS_JIRA_ID="$RELEASE_PLF_JIRA_ID"
ANSWERS_PATCHES=
ANSWERS_PATCHES_AFTER_RELEASE=

# ----------------------------CAS PROPERTIES-----------------------------
RELEASE_CAS_BRANCH=release/1.1.x
CURRENT_SNAPSHOT_CAS_VERSION=1.1.x-SNAPSHOT
RELEASE_CAS_VERSION=1.1.0-RC1-1
NEXT_SNAPSHOT_CAS_VERSION=1.1.x-SNAPSHOT
RELEASE_CAS_JIRA_ID="$RELEASE_PLF_JIRA_ID"
CAS_PATCHES=
CAS_PATCHES_AFTER_RELEASE=


# ----------------------------CMIS PROPERTIES-----------------------------
RELEASE_CMIS_BRANCH=release/4.3.x
CURRENT_SNAPSHOT_CMIS_VERSION=4.3.x-SNAPSHOT
RELEASE_CMIS_VERSION=4.3.0-RC1-1
NEXT_SNAPSHOT_CMIS_VERSION=4.3.x-SNAPSHOT
RELEASE_CMIS_JIRA_ID="$RELEASE_PLF_JIRA_ID"
CMIS_PATCHES=
CMIS_PATCHES_AFTER_RELEASE=


# ----------------------------IDE PROPERTIES-----------------------------
RELEASE_IDE_BRANCH=release/1.5.x
CURRENT_SNAPSHOT_IDE_VERSION=1.5.x-SNAPSHOT
RELEASE_IDE_VERSION=1.5.0-RC1-1
NEXT_SNAPSHOT_IDE_VERSION=1.5.x-SNAPSHOT
RELEASE_IDE_JIRA_ID="$RELEASE_PLF_JIRA_ID"
IDE_PATCHES=
IDE_PATCHES_AFTER_RELEASE=

# ----------------------------JOSSO PROPERTIES-----------------------------
RELEASE_JOSSO_BRANCH=release/1.1.x
CURRENT_SNAPSHOT_JOSSO_VERSION=1.1.x-SNAPSHOT
RELEASE_JOSSO_VERSION=1.1.0-RC1-1
NEXT_SNAPSHOT_JOSSO_VERSION=1.1.x-SNAPSHOT
RELEASE_JOSSO_JIRA_ID="$RELEASE_PLF_JIRA_ID"
JOSSO_PATCHES=
JOSSO_PATCHES_AFTER_RELEASE=

# ----------------------------OPENAM PROPERTIES-----------------------------
RELEASE_OPENAM_BRANCH=release/1.1.x
CURRENT_SNAPSHOT_OPENAM_VERSION=1.1.x-SNAPSHOT
RELEASE_OPENAM_VERSION=1.1.0-RC1-1
NEXT_SNAPSHOT_OPENAM_VERSION=1.1.x-SNAPSHOT
RELEASE_OPENAM_JIRA_ID="$RELEASE_PLF_JIRA_ID"
OPENAM_PATCHES=
OPENAM_PATCHES_AFTER_RELEASE=

# ----------------------------SAML PROPERTIES-----------------------------
RELEASE_SAML_BRANCH=release/1.1.x
CURRENT_SNAPSHOT_SAML_VERSION=1.1.x-SNAPSHOT
RELEASE_SAML_VERSION=1.1.0-RC1-1
NEXT_SNAPSHOT_SAML_VERSION=1.1.x-SNAPSHOT
RELEASE_SAML_JIRA_ID="$RELEASE_PLF_JIRA_ID"
SAML_PATCHES=
SAML_PATCHES_AFTER_RELEASE=

# ----------------------------SPNEGO PROPERTIES-----------------------------
RELEASE_SPNEGO_BRANCH=release/1.1.x
CURRENT_SNAPSHOT_SPNEGO_VERSION=1.1.x-SNAPSHOT
RELEASE_SPNEGO_VERSION=1.1.0-RC1-1
NEXT_SNAPSHOT_SPNEGO_VERSION=1.1.x-SNAPSHOT
RELEASE_SPNEGO_JIRA_ID="$RELEASE_PLF_JIRA_ID"
SPNEGO_PATCHES=
SPNEGO_PATCHES_AFTER_RELEASE=

# ----------------------------WAI PROPERTIES-----------------------------
RELEASE_WAI_BRANCH=release/4.3.x
CURRENT_SNAPSHOT_WAI_VERSION=4.3.x-SNAPSHOT
RELEASE_WAI_VERSION=4.3.0-RC1-1
NEXT_SNAPSHOT_WAI_VERSION=4.3.x-SNAPSHOT
RELEASE_WAI_JIRA_ID="$RELEASE_PLF_JIRA_ID"
WAI_PATCHES=
WAI_PATCHES_AFTER_RELEASE=
