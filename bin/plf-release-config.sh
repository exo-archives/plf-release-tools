...
RELEASE_MAVEN_DEPMGT_POM_BRANCH=stable/10.x
CURRENT_SNAPSHOT_MAVEN_DEPMGT_POM_VERSION=10.x-SNAPSHOT
RELEASE_MAVEN_DEPMGT_POM_VERSION=10
NEXT_SNAPSHOT_MAVEN_DEPMGT_POM_VERSION=10.x-SNAPSHOT
