...
RELEASE_DOCSTYLE_VERSION=4.1.1
...
# ----------------------------- MAVEN_DEPMGT_POM PROPERTIES -------------------
RELEASE_MAVEN_DEPMGT_POM_BRANCH=stable/9.x
CURRENT_SNAPSHOT_MAVEN_DEPMGT_POM_VERSION=9.x-SNAPSHOT
RELEASE_MAVEN_DEPMGT_POM_VERSION=9.1
NEXT_SNAPSHOT_MAVEN_DEPMGT_POM_VERSION=9.x-SNAPSHOT
RELEASE_MAVEN_DEPMGT_POM_JIRA_ID="$RELEASE_PLF_JIRA_ID"
MAVEN_DEPMGT_POM_PATCHES=
MAVEN_DEPMGT_POM_PATCHES_AFTER_RELEASE=
MAVEN_DEPMGT_POM_RELEASE_ADDITIONAL_OPTS_STRING=
...
RELEASE_GATEIN_PLF_VERSION=3.5.14-PLF
...
RELEASE_PLATFORM_UI_VERSION=4.1.1
...
RELEASE_CALENDAR_VERSION=4.1.1
...
RELEASE_INTEGRATION_VERSION=4.1.1
...
RELEASE_PLATFORM_VERSION=4.1.1
...
RELEASE_PLATFORM_PUBLIC_DISTRIBUTIONS_VERSION=4.1.1
...
RELEASE_PLATFORM_PRIVATE_DISTRIBUTIONS_VERSION=4.1.1
...
RELEASE_ACME_SAMPLE_BRANCH=stable/4.1.x
CURRENT_SNAPSHOT_ACME_SAMPLE_VERSION=4.1.x-SNAPSHOT
RELEASE_ACME_SAMPLE_VERSION=4.1.1
NEXT_SNAPSHOT_ACME_SAMPLE_VERSION=4.1.x-SNAPSHOT
...
RELEASE_WAI_SAMPLE_BRANCH=stable/4.1.x
CURRENT_SNAPSHOT_WAI_SAMPLE_VERSION=4.1.x-SNAPSHOT
RELEASE_WAI_SAMPLE_VERSION=4.1.1
NEXT_SNAPSHOT_WAI_SAMPLE_VERSION=4.1.x-SNAPSHOT
...
RELEASE_CHAT_APPLICATION_BRANCH=stable/1.0.x
CURRENT_SNAPSHOT_CHAT_APPLICATION_VERSION=1.0.x-SNAPSHOT
RELEASE_CHAT_APPLICATION_VERSION=1.0.1
NEXT_SNAPSHOT_CHAT_APPLICATION_VERSION=1.0.x-SNAPSHOT
...
RELEASE_WEEMO_EXTENSION_BRANCH=stable/1.0.x
CURRENT_SNAPSHOT_WEEMO_EXTENSION_VERSION=1.0.x-SNAPSHOT
RELEASE_WEEMO_EXTENSION_VERSION=1.0.1
NEXT_SNAPSHOT_WEEMO_EXTENSION_VERSION=1.0.x-SNAPSHOT
