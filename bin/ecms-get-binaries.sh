...
#curl --user $EXO_CREDENTIALS -L --location-trusted http://svn.exoplatform.org/projects/ecms/tags/$ECMS_VERSION/README.txt > binaries/WCM/$ECMS_VERSION/README.txt
...
#curl --location-trusted http://svn.exoplatform.org/projects/ecms/tags/$ECMS_VERSION/README.txt > binaries/WCM/$ECMS_VERSION/README.txt
