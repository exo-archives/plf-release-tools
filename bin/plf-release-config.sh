...
RELEASE_MAVEN_DEPMGT_VERSION=11-M2
...
CURRENT_SNAPSHOT_DOCSTYLE_VERSION=4.3.x-SNAPSHOT
RELEASE_DOCSTYLE_VERSION=4.3.0-M2
...
RELEASE_MAVEN_DEPMGT_POM_BRANCH=master
CURRENT_SNAPSHOT_MAVEN_DEPMGT_POM_VERSION=11-SNAPSHOT
RELEASE_MAVEN_DEPMGT_POM_VERSION=11-M2
...
RELEASE_GATEIN_PLF_BRANCH=stable/4.3.x-PLF
CURRENT_SNAPSHOT_GATEIN_PLF_VERSION=4.3.x-PLF-SNAPSHOT
RELEASE_GATEIN_PLF_VERSION=4.3.0-M2-PLF
...
RELEASE_JUZU_VERSION=1.1.0-M1
NEXT_SNAPSHOT_JUZU_VERSION=1.1.x-SNAPSHOT
...
CURRENT_SNAPSHOT_PLATFORM_UI_VERSION=4.3.x-SNAPSHOT
RELEASE_PLATFORM_UI_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_COMMONS_VERSION=4.3.x-SNAPSHOT
RELEASE_COMMONS_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_ECMS_VERSION=4.3.x-SNAPSHOT
RELEASE_ECMS_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_SOCIAL_VERSION=4.3.x-SNAPSHOT
RELEASE_SOCIAL_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_CALENDAR_VERSION=4.3.x-SNAPSHOT
RELEASE_CALENDAR_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_WIKI_VERSION=4.3.x-SNAPSHOT
RELEASE_WIKI_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_FORUM_VERSION=4.3.x-SNAPSHOT
RELEASE_FORUM_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_INTEGRATION_VERSION=4.3.x-SNAPSHOT
RELEASE_INTEGRATION_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_PLATFORM_VERSION=4.3.x-SNAPSHOT
RELEASE_PLATFORM_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_PLATFORM_PUBLIC_DISTRIBUTIONS_VERSION=4.3.x-SNAPSHOT
RELEASE_PLATFORM_PUBLIC_DISTRIBUTIONS_VERSION=4.3.0-M2
...
CURRENT_SNAPSHOT_PLATFORM_PRIVATE_DISTRIBUTIONS_VERSION=4.3.x-SNAPSHOT
RELEASE_PLATFORM_PRIVATE_DISTRIBUTIONS_VERSION=4.3.0-M2
