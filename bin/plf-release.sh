...
function init {
  ...
  "kernel")
    ...
    THIS_RELEASE_BRANCH="$RELEASE_KERNEL_BRANCH"
  ...
  "core")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_JBOSS_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_CORE_BRANCH"
  ...
  "ws")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_JBOSS_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_WS_BRANCH"
  ...
  "jcr")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_JBOSS_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_JCR_BRANCH"
  ...
  "jcr-services")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_JBOSS_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_JCR_SERVICES_BRANCH"
  ...
  "exogtn")
    ...
    THIS_RELEASE_BRANCH="$RELEASE_EXOGTN_BRANCH"
  ...
  "gwtframework")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_GWTFRAMEWORK_BRANCH"
  ...
  "ide")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_IDE_BRANCH"
  ...
  "commons")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_COMMONS_BRANCH"
  ...
  "ecms")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_ECMS_BRANCH"
  ...
  "social")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_SOCIAL_BRANCH"
  ...
  "cs")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_CS_BRANCH"
  ...
  "ks")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_KS_BRANCH"
  ...
  "platform")
    THIS_PROJECT="$1"
    THIS_MVN_CREDENTIALS="$MVN_EXO_CREDENTIALS"
    THIS_RELEASE_BRANCH="$RELEASE_PLATFORM_BRANCH"
