...
projects=(
  ...
  'maven-depmgt-pom' $RELEASE_MAVEN_DEPMGT_BRANCH
                  $RELEASE_MAVEN_DEPMGT_VERSION
  'acme-sample' $RELEASE_ACME_SAMPLE_BRANCH $RELEASE_ACME_SAMPLE_VERSION
  'wai-sample' $RELEASE_WAI_SAMPLE_BRANCH $RELEASE_WAI_SAMPLE_VERSION
  'chat-application' $RELEASE_CHAT_APPLICATION_BRANCH $RELEASE_CHAT_APPLICATION_VERSION
  'weemo-extension' $RELEASE_WEEMO_EXTENSION_BRANCH $RELEASE_WEEMO_EXTENSION_VERSION
  )
